...
def test_retaining_2_connected_subgraphs():
    n = Network('epsg:27700')
    n.add_link('0', 1, 2, attribs={'modes': {'walk'}, 'length': 1})
    n.add_link('1', 2, 3, attribs={'modes': {'walk', 'car'}, 'length': 1})
    n.add_link('2', 3, 2, attribs={'modes': {'walk', 'car'}, 'length': 1})
    n.add_link('3', 2, 1, attribs={'modes': {'car'}, 'length': 1})
    n.add_link('4', 1, 4, attribs={'modes': {'car'}, 'length': 1})
    n.add_link('5', 4, 5, attribs={'modes': {'car'}, 'length': 1})
    n.add_link('5', 5, 4, attribs={'modes': {'car'}, 'length': 1})
    n.add_link('6', 5, 5, attribs={'modes': {'car'}, 'length': 1})
    n.retain_n_connected_subgraphs(2, 'car')
    assert_semantically_equal(dict(n.links()),
                              {'0': {'modes': {'walk'}, 'length': 1, 'from': 1, 'to': 2, 'id': '0'},
                               '1': {'modes': {'car', 'walk'}, 'length': 1, 'from': 2, 'to': 3, 'id': '1'},
                               '2': {'modes': {'car', 'walk'}, 'length': 1, 'from': 3, 'to': 2, 'id': '2'},
                               '5': {'modes': {'car'}, 'length': 1, 'from': 4, 'to': 5, 'id': '5'},
                               '6': {'modes': {'car'}, 'length': 1, 'from': 5, 'to': 4, 'id': '6'},
                               '7': {'modes': {'car'}, 'length': 1, 'from': 5, 'to': 5, 'id': '7'}})
